...
public class ShootingEnemyHealther : MonoBehaviour
{
    ...
    [SerializeField] private ShootingEnemyCollisionChecker shooingEnemyCollisionChecker;
    ...
    void Update()
    {
        ...
        {
            if (shooingEnemyCollisionChecker.isDamage)
            {
                isDead = true;
                isDissolving = true;
            }
